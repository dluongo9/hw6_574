...
class VanillaRNNCell(nn.Module):
    ...
    def forward(self, prev_hidden: Tensor, cur_input: Tensor) -> Tensor:
        ...
        return torch.tanh(self.hidden2hidden(prev_hidden) + self.input2hidden(cur_input))
...
class LSTMCell(nn.Module):
    ...
    def forward(
        ...
        # [batch_size, hidden_dim + embedding_dim]
        ...
        c_hat_t = torch.tanh(self.candidate_linear(combined_input))
        c_t = f_t * prev_memory + i_t * c_hat_t
